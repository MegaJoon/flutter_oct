...
//              color: Colors.amber,
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: IconButton(icon: Icon(Icons.home, size: 32.0, color: Colors.black), onPressed: (){
                setState(() {
